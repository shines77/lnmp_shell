...
Check_Download_Files()
{
    ...
    Download_File ${Download_Mirror}/web/mcrypt/${Mcypt_Ver}.tar.gz ${Mcypt_Ver}.tar.gz
    Download_File ${Download_Mirror}/web/mhash/${Mash_Ver}.tar.gz ${Mash_Ver}.tar.gz
    ...
    if [[ "${Stack}" == "lamp" || "${Stack}" == "lnamp" ]]; then
        ...
        Download_File ${Download_Mirror}/web/apache/rpaf/${Mod_RPAF_Ver}.tar.gz ${Mod_RPAF_Ver}.tar.gz
    fi
}
